...
function drawType() {
  ...
  if (avgCounter < 46) {
    ...
    radiusMap = map(calculateAverage(200, 255), 0, 255, 30, 0);
    widthMap = map(
    ...
    weightMap = map(calculateAverage(0, 255), 0, 100, 80, 1);
  }
